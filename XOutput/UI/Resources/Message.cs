...
namespace XOutput.UI.Resources
{
    public static class Message
    {
        ...
        public static string ScpDownload { get { return "VIGEm is mandatory to use this application." + Environment.NewLine + "It can be downloaded from: https://github.com/nefarius/ViGEm/wiki/Driver-Installation"; } }
    }
}
