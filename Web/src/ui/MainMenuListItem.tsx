...
class MainMenuListItemComponent extends React.Component<MainMenuListItemProps> {
    ...
    render() {
        ...
        return <ListItem button component={Link} to={this.props.path} onClick={() => this.props.onClick ? this.props.onClick() : null} selected={this.props.path === location.pathname}>
            {this.props.children}
        </ListItem>;
    }
}
