    ...
    render() {
        ...
        return <>
            ...
            <Async task={this.loading}>
                { (notifications: Notification[]) =>
                    notifications.map(n => <Card key={n.id} className={classes.card} style={{display: 'flex'}}>
                        ...
                        { n.acknowledged ? null : <Button variant="contained" color='primary' onClick={() => this.acknowledge(n.id)}>
