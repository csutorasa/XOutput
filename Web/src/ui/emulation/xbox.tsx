    ...
    render() {
        ...
        return <div className="root">
            ...
            <Square style={{ gridColumn: "span 7", gridRow: "span 8" }}>
                <div><Button input="Back" circle={true} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div>
                ...
                <div><Button input="Start" circle={true} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div></div>
                <div><Button input="Home" circle={true} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div></div>
            ...
            <Square style={{ gridColumn: "span 6", gridRow: "span 8" }}>
                <div></div>
                <div><Button input="Y" circle={true} style={{ backgroundColor: "yellow", color: "orangered" }} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div></div>
                <div><Button input="X" circle={true} style={{ backgroundColor: "blue", color: "lightblue" }} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div></div>
                <div><Button input="B" circle={true} style={{ backgroundColor: "red", color: "darkred" }} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div></div>
                <div><Button input="A" circle={true} style={{ backgroundColor: "green", color: "lightgreen" }} eventHolder={this.eventHolder} websocket={this.websocketSession} emulator={emulator}></Button></div>
                <div></div>
            </Square>
